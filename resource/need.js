...
function _gas(data, key0,
    ...
    var key = CryptoJS.enc.Utf8.parse(key0);//x.parse  获得四个数组
    var iv = CryptoJS.enc.Utf8.parse(iv0);//获得四个数组
    var decrypted = CryptoJS.AES.encrypt(data, key, {//哈希加密
        iv: iv,
...
function myencode(_p0,_p1){
    _p2 = encryptAES(_p0, _p1);
    return _p2;
}
// var p1="WC0H7Iqwp1GGzRaB"
// var p2="666666"
// console.log(myencode(p2,p1))